...
var empty_fname="Please enter the first name in shipping address";
var empty_lname="Please enter the last name in shipping address";
var empty_address="Please enter the shipping address";
var empty_city="Please enter the city name in shipping address";
var empty_state="Please enter the two letter state abbreviation in shipping address";
var empty_zip="Please enter the zip code in shipping address";
...
var empty_sfname="Please enter the first name in billing address";
var empty_slname="Please enter the last name in billing address";
var empty_saddress="Please enter the billing address";
var empty_scity="Please enter the city name in billing address";
var empty_sstate="Please enter your two letter state abbreviation in billing address";
var empty_szip="Please enter the zip code in billing address";
...
function fetchCart()
{
  ...
  $('#show_billing').html("<input type='button' class='shop' name='continue_shop' value='Continue Shopping' />")
  $("#billing_cart").css("display","none");
  ...
  {  
    toWrite += "<tr>";
     toWrite +="<td><img src=\'"+cartArray[i][4]+"\' alt='"+cartArray[i][0]+"'"+" width='50'"+" /></td>";
  ...
  $("table#bill_info").css("float","right");
  $("table#bill_info").css("width","30%");
  $("table#bill_info tr:last-child").css("border-top","1px dotted #AAA");
  //$("table#bill_info").html(bill);
